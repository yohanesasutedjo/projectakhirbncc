...
<title><?php echo $__env->yieldContent('title', 'TokoKu'); ?></title>
...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-menu">
    <?php if(auth()->user()->isAdmin()): ?>
      ...
      <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>"><i class="bi bi-speedometer2"></i> Dashboard</a>
      <div class="sidebar-label mt-2">Manajemen</div>
      <a href="<?php echo e(route('admin.categories.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.categories.*') ? 'active' : ''); ?>"><i class="bi bi-tags"></i> Kategori Barang</a>
      <a href="<?php echo e(route('admin.items.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.items.*') ? 'active' : ''); ?>"><i class="bi bi-box-seam"></i> Data Barang</a>
      <a href="<?php echo e(route('admin.items.create')); ?>" class="sidebar-link"><i class="bi bi-plus-circle"></i> Tambah Barang</a>
    <?php else: ?>
      <div class="sidebar-label">Menu</div>
      <a href="<?php echo e(route('user.catalog')); ?>" class="sidebar-link <?php echo e(request()->routeIs('user.catalog') ? 'active' : ''); ?>"><i class="bi bi-grid"></i> Katalog Barang</a>
      <a href="<?php echo e(route('user.cart')); ?>" class="sidebar-link <?php echo e(request()->routeIs('user.cart') ? 'active' : ''); ?>">
        <i class="bi bi-cart3"></i> Keranjang
        <?php $cc = count(session('cart', [])); ?>
        <?php if($cc > 0): ?><span class="badge bg-danger ms-auto"><?php echo e($cc); ?></span><?php endif; ?>
      </a>
      <a href="<?php echo e(route('user.invoice.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('user.invoice.index') ? 'active' : ''); ?>"><i class="bi bi-receipt"></i> Buat Faktur</a>
      <a href="<?php echo e(route('user.invoice.history')); ?>" class="sidebar-link <?php echo e(request()->routeIs('user.invoice.history') ? 'active' : ''); ?>"><i class="bi bi-clock-history"></i> Riwayat Faktur</a>
    <?php endif; ?>
  </nav>
  <div class="sidebar-footer">
    <div class="d-flex align-items-center gap-2">
      ...
      <div>
        ...
        <small style="color:#94a3b8;font-size:.72rem"><?php echo e(ucfirst(auth()->user()->role)); ?></small>
      </div>
    </div>
...
<div class="main-wrapper">
  <div class="topbar">
    <div class="d-flex align-items-center gap-3">
      ...
      <span style="font-weight:600;color:#1e293b"><?php echo $__env->yieldContent('page-title','Dashboard'); ?></span>
    </div>
    <div class="d-flex align-items-center gap-2">
      <?php if(auth()->user()->isUser()): ?>
        <a href="<?php echo e(route('user.cart')); ?>" class="btn btn-sm btn-outline-primary position-relative">
          <i class="bi bi-cart3"></i>
          <?php $cc=count(session('cart',[])); ?>
          <?php if($cc>0): ?><span class="cart-count-badge"><?php echo e($cc); ?></span><?php endif; ?>
        </a>
      <?php endif; ?>
      <span class="badge bg-light text-dark border"><?php echo e(ucfirst(auth()->user()->role)); ?></span>
    </div>
  </div>
  <div class="page-content">
    <?php if(session('success')): ?><div class="alert alert-success alert-dismissible fade show d-flex align-items-center gap-2 mb-3"><i class="bi bi-check-circle-fill"></i><div><?php echo e(session('success')); ?></div><button type="button" class="btn-close" data-bs-dismiss="alert"></button></div><?php endif; ?>
    <?php if(session('error')): ?><div class="alert alert-danger alert-dismissible fade show d-flex align-items-center gap-2 mb-3"><i class="bi bi-exclamation-triangle-fill"></i><div><?php echo e(session('error')); ?></div><button type="button" class="btn-close" data-bs-dismiss="alert"></button></div><?php endif; ?>
    <?php if($errors->any()): ?><div class="alert alert-danger alert-dismissible fade show mb-3"><i class="bi bi-exclamation-triangle-fill me-2"></i><strong>Terjadi kesalahan:</strong><ul class="mb-0 mt-1"><?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li><?php echo e($e); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></ul><button type="button" class="btn-close" data-bs-dismiss="alert"></button></div><?php endif; ?>
...
<?php /**PATH D:\XAMPP\htdocs\files\tokoku\resources\views/layouts/app.blade.php ENDPATH**/ ?>